    ...
    <div className="min-h-screen bg-[#011d5a] text-white flex flex-col font-sans">
      ...
      <main className="flex-1">
            ...
            {ARTISTS.map((artist, i) => (
              <Reveal key={artist.name} delay={i * 0.06}>
                <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center ${i % 2 === 1 ? "" : ""}`}>
                  {/* Image */}
                  <div className={`relative aspect-[4/5] rounded-[2rem] overflow-hidden border border-[#011d5a]/10 shadow-xl ${i % 2 === 1 ? "lg:order-2" : ""}`}>
                    <Image
                      src={artist.image}
                      alt={artist.name}
                      fill
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#011d5a]/40 via-transparent to-transparent" />
                  ...
                  <div className={`space-y-6 ${i % 2 === 1 ? "lg:order-1" : ""}`}>
                    <div>
                      <span className="text-[10px] font-bold text-[#011d5a]/30 uppercase tracking-[0.3em]">{artist.role}</span>
                      <h3 className="font-sans font-bold text-4xl md:text-5xl tracking-tight mt-2">
                        {artist.name}
                      </h3>
                    </div>
                    <p className="text-base text-[#011d5a]/40 font-light">{artist.stats}</p>
                    <div className="w-12 h-1 bg-[#011d5a]/10 rounded-full" />

                    {/* Spotify Embed */}
                    <div className="rounded-xl overflow-hidden border border-[#011d5a]/10 mt-4">
                      <iframe
        ...
        {/* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
            CTA
        ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */}
        <section className="py-24 md:py-32 px-6 bg-[#011d5a] text-center border-t border-white/5">
          <Reveal>
