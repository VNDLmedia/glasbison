...
export function Marquee({ children, speed = 40, reverse = false, className = "" }: MarqueeProps) {
  ...
  return (
    <div className={`overflow-hidden relative flex w-full ${className}`}>
      <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#011d5a] to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#011d5a] to-transparent z-10 pointer-events-none" />
